...
-- Membuang struktur basisdata untuk stunting_app
CREATE DATABASE IF NOT EXISTS `stunting_app` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `stunting_app`;

-- membuang struktur untuk table stunting_app.laki_berat_badan_0_60
CREATE TABLE IF NOT EXISTS `laki_berat_badan_0_60` (
  `umur_bulan` int(2) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
  `median` decimal(3,1) DEFAULT NULL,
  `sd_plus_1` decimal(3,1) DEFAULT NULL,
  `sd_plus_2` decimal(3,1) DEFAULT NULL,
  `sd_plus_3` decimal(3,1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Membuang data untuk tabel stunting_app.laki_berat_badan_0_60: ~61 rows (lebih kurang)
INSERT INTO `laki_berat_badan_0_60` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.laki_tinggi_badan_0_24
CREATE TABLE IF NOT EXISTS `laki_tinggi_badan_0_24` (
...
-- Membuang data untuk tabel stunting_app.laki_tinggi_badan_0_24: ~25 rows (lebih kurang)
INSERT INTO `laki_tinggi_badan_0_24` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.laki_tinggi_badan_24_60
CREATE TABLE IF NOT EXISTS `laki_tinggi_badan_24_60` (
  `umur_bulan` int(3) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(4,1) DEFAULT NULL,
  `median` decimal(4,1) DEFAULT NULL,
  `sd_plus_1` decimal(4,1) DEFAULT NULL,
  `sd_plus_2` decimal(4,1) DEFAULT NULL,
  `sd_plus_3` decimal(4,1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Membuang data untuk tabel stunting_app.laki_tinggi_badan_24_60: ~37 rows (lebih kurang)
INSERT INTO `laki_tinggi_badan_24_60` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
	...
	(59, 95.6, 99.9, 104.8, 109.4, 114.0, 118.6, 123.2),
	(60, 96.1, 99.9, 105.3, 110.0, 114.6, 119.2, 123.9);

-- membuang struktur untuk table stunting_app.laki__bb_pb__0_24bln
CREATE TABLE IF NOT EXISTS `laki__bb_pb__0_24bln` (
...
-- Membuang data untuk tabel stunting_app.laki__bb_pb__0_24bln: ~131 rows (lebih kurang)
INSERT INTO `laki__bb_pb__0_24bln` (`tinggi_badan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
	...
	(65.0, 5.7, 6.2, 6.7, 7.2, 7.9, 8.6, 9.4),
	...
	(88.0, 9.7, 10.5, 11.3, 12.2, 13.3, 14.4, 15.8),
...
-- membuang struktur untuk table stunting_app.laki__bb_pb__24_60bln
CREATE TABLE IF NOT EXISTS `laki__bb_pb__24_60bln` (
  `tinggi_badan` decimal(4,1) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.laki__bb_pb__24_60bln: ~111 rows (lebih kurang)
INSERT INTO `laki__bb_pb__24_60bln` (`tinggi_badan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.perempuan_berat_badan_0_24
CREATE TABLE IF NOT EXISTS `perempuan_berat_badan_0_24` (
  `umur_bulan` int(2) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.perempuan_berat_badan_0_24: ~61 rows (lebih kurang)
INSERT INTO `perempuan_berat_badan_0_24` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.perempuan_tinggi_badan_0_24
CREATE TABLE IF NOT EXISTS `perempuan_tinggi_badan_0_24` (
  `umur_bulan` int(2) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.perempuan_tinggi_badan_0_24: ~25 rows (lebih kurang)
INSERT INTO `perempuan_tinggi_badan_0_24` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.perempuan_tinggi_badan_24_60
CREATE TABLE IF NOT EXISTS `perempuan_tinggi_badan_24_60` (
  `umur_bulan` int(2) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(4,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.perempuan_tinggi_badan_24_60: ~37 rows (lebih kurang)
INSERT INTO `perempuan_tinggi_badan_24_60` (`umur_bulan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
...
-- membuang struktur untuk table stunting_app.perempuan__bb_pb__0_24
CREATE TABLE IF NOT EXISTS `perempuan__bb_pb__0_24` (
  `tinggi_badan` decimal(4,1) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.perempuan__bb_pb__0_24: ~131 rows (lebih kurang)
INSERT INTO `perempuan__bb_pb__0_24` (`tinggi_badan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
	...
	(104.5, 12.6, 13.8, 15.0, 16.4, 18.0, 19.9, 21.9),
	(105.0, 12.7, 13.9, 15.1, 16.5, 18.2, 20.1, 22.2),
	(105.5, 12.9, 14.1, 15.3, 16.7, 18.3, 20.3, 22.4),
	(106.0, 13.0, 14.2, 15.4, 16.8, 18.5, 20.5, 22.6),
	(106.5, 13.1, 14.4, 15.6, 17.0, 18.7, 20.8, 22.9),
	(107.0, 13.2, 14.5, 15.7, 17.1, 18.9, 21.0, 23.1),
	(107.5, 13.4, 14.7, 15.9, 17.3, 19.0, 21.3, 23.4),
	(108.0, 13.5, 14.9, 16.0, 17.5, 19.2, 21.5, 23.6),
	(108.5, 13.6, 15.0, 16.2, 17.6, 19.4, 21.7, 23.9),
	(109.0, 13.8, 15.2, 16.4, 17.8, 19.6, 22.0, 24.2),
	(109.5, 13.9, 15.3, 16.5, 18.0, 19.8, 22.2, 24.5),
	(110.0, 14.1, 15.5, 16.7, 18.1, 20.0, 22.5, 24.8);

-- membuang struktur untuk table stunting_app.perempuan__bb_tb__24_60
CREATE TABLE IF NOT EXISTS `perempuan__bb_tb__24_60` (
  `tinggi_badan` decimal(4,1) DEFAULT NULL,
  `sd_minus_3` decimal(3,1) DEFAULT NULL,
  `sd_minus_2` decimal(3,1) DEFAULT NULL,
  `sd_minus_1` decimal(3,1) DEFAULT NULL,
...
-- Membuang data untuk tabel stunting_app.perempuan__bb_tb__24_60: ~111 rows (lebih kurang)
INSERT INTO `perempuan__bb_tb__24_60` (`tinggi_badan`, `sd_minus_3`, `sd_minus_2`, `sd_minus_1`, `median`, `sd_plus_1`, `sd_plus_2`, `sd_plus_3`) VALUES
	...
	(69.5, 6.4, 6.9, 7.5, 8.2, 9.0, 9.9, 10.9),
...
-- membuang struktur untuk table stunting_app.table_hasil
CREATE TABLE IF NOT EXISTS `table_hasil` (
  `berat_badan.umur` varchar(30) NOT NULL,
  `tinggi_badan.umur` varchar(30) NOT NULL,
  `bb.tb` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Membuang data untuk tabel stunting_app.table_hasil: ~0 rows (lebih kurang)

-- membuang struktur untuk table stunting_app.table_user
...
-- Membuang data untuk tabel stunting_app.table_user: ~13 rows (lebih kurang)
INSERT INTO `table_user` (`ID_User`, `Alamat`, `Nama_orangtua`, `Nama_anak`, `Tanggal_pengukuran`, `Tanggal_lahir`, `Bulan`, `Jenis_kelamin`, `Berat_badan`, `Tinggi_badan`) VALUES
	(1, 'Jl. Contoh No. 123', 'Andi', 'Anita', '2023-10-10', '2019-05-15', NULL, 'Perempuan', 13, 87),
	(2, 'Jl. Sample St. 456', 'Rudi', 'Sarah', '2023-10-10', '2018-11-20', NULL, 'Perempuan', 14, 94),
	(3, 'Jl. Demo No. 789', 'Susi', 'Rina', '2023-10-10', '2020-02-18', NULL, 'Perempuan', 12, 82),
	(4, 'Jl. Test St. 1010', 'Budi', 'Lisa', '2023-10-10', '2019-08-30', NULL, 'Perempuan', 14, 95),
	(5, 'Jl. Contoh 2 No. 456', 'Agus', 'Karina', '2023-10-10', '2021-03-10', NULL, 'Perempuan', 11, 77),
	(6, 'Jl. Example St. 789', 'Doni', 'Denny', '2023-10-10', '2022-04-25', NULL, 'Laki-laki', 10, 70),
	(7, 'Jl. Uji Coba No. 1010', 'Eko', 'Farhan', '2023-10-10', '2023-01-05', NULL, 'Laki-laki', 9, 65),
	(8, 'Jl. Tes St. 1212', 'Heru', 'Gilang', '2023-10-10', '2022-11-15', NULL, 'Laki-laki', 9, 68),
	(9, 'Jl. Dummy No. 1313', 'Ivan', 'Hari', '2023-10-10', '2023-03-20', NULL, 'Laki-laki', 8, 62),
	(10, 'Jl. Percobaan 1 No. 1414', 'Joko', 'Irfan', '2023-10-10', '2023-06-12', NULL, 'Laki-laki', 8, 59),
	(11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(12, NULL, NULL, 'asf', '2023-10-17', NULL, 6, 'Laki-laki', 12, 50),
	(13, NULL, NULL, 'RUDI', '2023-10-18', NULL, 6, 'Perempuan', 14, 59);
